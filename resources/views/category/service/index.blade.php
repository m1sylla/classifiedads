...
<head>
    ...
    <meta name="keywords" content="Guinée, Conakry, Yetecan, Annonces, Service, Prestataires, Evénementiels">
    <meta name="description" content="Trouver des prestaires de service, événementiel, publicité, marketing, déménagement, mariage.">
    
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>Service - Trouvez des plombiers, réparateurs sur yetecan.com </title>
