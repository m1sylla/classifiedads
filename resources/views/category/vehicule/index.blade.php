...
<head>
    ...
    <meta name="keywords" content="Guinée, Conakry, Yetecan, Annonces, Véhicules, Voitures, Motos, Vélos">
    <meta name="description" content="Vente, achat et location de véhicules en Guinée, voitures, motos, pièces détachées, vélos.">
    
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>Véhicule - Trouvez des voitures, motos, vélos sur yetecan.com </title>
