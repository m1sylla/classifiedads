...
<head>
    ...
    <meta name="keywords" content="Guinée, Conakry, Yetecan, Annonces, Vente, Achat, Location, Mode, Chaussures, Vêtements">
    <meta name="description" content="Vente et location des accessoires de mode, produits cosmétiques, chaussures, vêtements.">
    
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>Mode - Trouvez des chaussures, des habits sur yetecan.com</title>
